...
<html>
			...
			<nav>
					<ul>
						...
						<div class="dropdown-content">
							...
							<a class="active" href="webstore-sights.php">Miras</a>
    ...
    <section>
			<div id="photolinks">
			  ...
			  <map name="warrior3D">
			    <area shape="poly" coords="144,528,571,543,649,485,761,513,1517,563,1517,688,1004,658,984,776,774,794,747,693,460,633,166,771" alt="gun"href="webstore-rifles.php"href="webstore-rifles.php">
		...
		<?php
			...
			$sql = "SELECT * FROM produtos where idTipoProdutos = 4";
